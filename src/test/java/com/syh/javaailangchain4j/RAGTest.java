...
//        Document document = FileSystemDocumentLoader.loadDocument("/Users/syh/Java_Workspace/java-ai-langChain4j/knowledge/测试.txt");
//        System.out.println(document.text());

        // 加载单个文档
//        Document document = FileSystemDocumentLoader.loadDocument("/Users/syh/Java_Workspace/java-ai-langChain4j/knowledge/file.txt", new TextDocumentParser());

        // 从一个目录中加载所有文档
//        List<Document> documents = FileSystemDocumentLoader.loadDocuments("/Users/syh/Java_Workspace/java-ai-langChain4j/knowledge", new TextDocumentParser());


        // 从一个目录中加载所有的.txt文档
        PathMatcher pathMatcher = FileSystems.getDefault().getPathMatcher("glob:*.txt");
        List<Document> documents = FileSystemDocumentLoader.loadDocuments("/Users/syh/Java_Workspace/java-ai-langChain4j/knowledge", pathMatcher, new TextDocumentParser());
    ...
    public void testParsePDF() {
        Document document = FileSystemDocumentLoader.loadDocument(
                "/Users/syh/Java_Workspace/java-ai-langChain4j/knowledge/医院信息.pdf",
    ...
    */
    ...
    public void testReadDocumentAndStore() {
        ...
        Document document = FileSystemDocumentLoader.loadDocument("/Users/syh/Java_Workspace/java-ai-langChain4j/knowledge/人工智能.md");
